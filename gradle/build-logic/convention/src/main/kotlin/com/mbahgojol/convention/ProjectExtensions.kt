...
val VersionCatalog.compileSdkVersion
    get() = findVersion("android-compile-sdk").get().toString().toInt()

val VersionCatalog.minSdkVersion get() = findVersion("android-min-sdk").get().toString().toInt()
val VersionCatalog.targetSdkVersion get() = findVersion("android-target-sdk").get().toString().toInt()
